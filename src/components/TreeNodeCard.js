...
function TreeNodeCard({ 
  ...
  const calculateAge = (birthDate, deathDate) => {
    ...
    if (deathDate) {
      ...
      const death = deathDate.seconds ? new Date(deathDate.seconds * 1000) : new Date(deathDate);
        ...
        >
          ...
          <div className="text-center mb-4">
            ...
            <p className="text-sm text-gray-500">
              {member.gender === 'male' ? 'Son' : member.gender === 'female' ? 'Daughter' : 'Family Member'}
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4 mb-4">
            ...
            <div className="text-center">
              <div className="text-lg font-bold text-gray-900">
                {allMembers ? allMembers.filter(m => m.parentIds && m.parentIds.includes(member.id)).length : 0}
              </div>
          ...
          <div className="relative group">
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-4 mb-4">
                ...
                <div className="text-center">
                  <div className="text-lg font-bold text-gray-900">
                    {allMembers ? allMembers.filter(m => m.parentIds && m.parentIds.includes(spouse.id)).length : 0}
                  </div>
                  <div className="text-xs text-gray-500">Children</div>
                </div>
              </div>
