      ...
      <div className={`flex items-center justify-center min-h-[600px] ${className}`}>
        <div className="text-center max-w-2xl mx-auto px-8">
          ...
          <div className="relative mb-8">
            <div className="relative w-80 h-48 mx-auto">
              ...
              >
                ...
                <circle cx="70" cy="85" r="12" fill="#FF385C" className="opacity-70" />
                <circle cx="95" cy="70" r="10" fill="#00A699" className="opacity-70" />
                <circle cx="160" cy="100" r="14" fill="#FF385C" className="opacity-80" />
                <circle cx="240" cy="80" r="12" fill="#00A699" className="opacity-70" />
                <circle cx="245" cy="70" r="10" fill="#FF385C" className="opacity-60" />
                ...
                <circle cx="50" cy="60" r="2" fill="#00A699" className="opacity-30 animate-pulse" />
                <circle cx="270" cy="55" r="2" fill="#FF385C" className="opacity-30 animate-pulse" />
                <circle cx="160" cy="50" r="1.5" fill="#4A5568" className="opacity-20 animate-pulse" />
              </svg>
          ...
          <h2 className="text-3xl font-semibold text-gray-800 mb-6 leading-tight">
            Every Family Tree Starts<br />
            <span className="text-airbnb-rausch">With a Single Story</span>
          </h2>
          
          {/* Emotional copy */}
          <p className="text-gray-600 text-lg mb-8 leading-relaxed">
            Imagine generations of your family flowing together like branches of a living tree. 
            Each person you add becomes part of a beautiful story that connects past, present, and future.
          </p>
    ...
    <div className={`w-full ${className}`}>
      ...
      <div className="flex justify-between items-center mb-8 px-4">
        <div className="flex-1">
          <h2 className="text-2xl font-semibold text-gray-800">Your Family's Story</h2>
                  ...
                  renderOption={(member, isHighlighted) => (
                    <div
                      className={`flex items-center gap-3 text-sm py-3 px-4 ${
                        isHighlighted ? "text-airbnb-rausch bg-red-50" : "text-gray-900"
                      }`}
                    >
                      ...
                      <div className="flex-1">
                        ...
                        {member.birthDate && (
                          <span className="text-xs text-gray-500 ml-2">
                            Born {new Date(member.birthDate.seconds * 1000).getFullYear()}
                          </span>
                        )}
                      </div>
                      <span
      ...
      <div className="relative overflow-x-auto overflow-y-visible">
        <div className="relative min-w-full py-12 bg-gradient-to-br from-orange-50/60 via-amber-50/40 to-rose-50/60 rounded-3xl overflow-hidden">
          ...
          <div className="absolute inset-0 pointer-events-none">
            ...
            <svg className="absolute top-4 left-4 opacity-10" width="120" height="80" viewBox="0 0 120 80">
              <path
            ...
            <svg className="absolute bottom-6 right-6 opacity-10 transform rotate-180" width="100" height="60" viewBox="0 0 100 60">
              <path
            ...
            <div className="absolute top-8 right-16 w-2 h-2 bg-amber-200 rounded-full opacity-30 animate-pulse" style={{animationDelay: '0s', animationDuration: '3s'}} />
            <div className="absolute bottom-12 left-20 w-1.5 h-1.5 bg-rose-200 rounded-full opacity-40 animate-pulse" style={{animationDelay: '1s', animationDuration: '4s'}} />
            <div className="absolute top-20 left-1/3 w-1 h-1 bg-orange-300 rounded-full opacity-25 animate-pulse" style={{animationDelay: '2s', animationDuration: '5s'}} />
          </div>
