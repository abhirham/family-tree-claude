    ...
    <form onSubmit={handleSubmit} className="space-y-8">
      ...
      <div className="text-center space-y-4">
        ...
        <p className="text-gray-600">
          Photos help us remember the people we love most
        </p>
            ...
            >
              <div className="w-48 h-48 mx-auto border-3 border-dashed border-gray-300 rounded-2xl flex flex-col items-center justify-center gap-4 hover:border-airbnb-rausch hover:bg-red-50 transition-all duration-200 group-hover:scale-105">
                <div className="w-16 h-16 bg-gray-100 rounded-full flex items-center justify-center group-hover:bg-red-100 transition-colors">
                  <svg
                    className="w-8 h-8 text-gray-400 group-hover:text-airbnb-rausch"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
                ...
                <div className="text-center">
                  <span className="text-base text-gray-700 group-hover:text-airbnb-rausch font-medium">
                    Add their photo
                  </span>
        ...
        <p className="text-xs text-gray-500">
          Don't have a photo? That's okay - you can always add one later
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="space-y-2">
          ...
          />
          <p className="text-xs text-gray-500">
            If you're not sure of the exact date, that's okay
          </p>
        </div>
          ...
          <div className="border-2 border-dashed border-gray-300 rounded-xl p-6 text-center hover:border-blue-400 transition-colors">
            ...
            >
              ...
              <span className="text-xs text-gray-400">
                Multiple images up to 10MB each (max 10, auto-compressed)
              </span>
            </label>
          </div>
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              ...
              <AutoComplete
                ...
                onSelect={(value) =>
                  handleChange({ target: { name: "linkedMemberId", value } })
                }
            ...
            <div className="space-y-2">
              ...
              <AutoComplete
                options={(() => {
                  ...
                  if (formData.linkedMemberId) {
                    ...
                    baseOptions.push({
                      ...
                      label: isRootUser
                        ? "Sibling"
                        : "Sibling (only available for root users)",
                      enabled: isRootUser,
                    });
                  }
                ...
                onSelect={(value, option) => {
                  if (option.enabled) {
                    handleChange({
                      target: { name: "relationshipType", value },
                    });
                  }
                }}
              ...
              {formData.relationshipType === "spouse" && (
                <div className="bg-orange-50 border border-orange-200 rounded-lg p-3 mt-2">
                  <p className="text-xs text-orange-800 flex items-center gap-2">
                    ...
                    <span>
                      When adding a spouse, you can later add their parents and
                      children
                    </span>
                  </p>
                </div>
                    ...
                    return (
                      <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 mt-2">
                        <p className="text-xs text-blue-800 flex items-center gap-2">
                          ...
                          <span>
                            {selectedMember.name} already has parent
                            {existingParents.length > 1 ? "s" : ""}:{" "}
                            {existingParents.map((p) => p.name).join(", ")}.
                            This person will be added as a spouse to{" "}
                            {existingParents[0].name} instead.
                          </span>
                        </p>
                      </div>
                    );
                    ...
                    return (
                      <div className="bg-red-50 border border-red-200 rounded-lg p-3 mt-2">
                        <p className="text-xs text-red-800 flex items-center gap-2">
                          ...
                          <span>
                            Cannot add a child to a user without a spouse.
                            Please add a spouse first.
                          </span>
                        </p>
                      </div>
                    );
